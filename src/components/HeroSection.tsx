    ...
    <section className="flex min-h-screen flex-col items-center justify-center px-6">
      <div className="mx-auto max-w-3xl text-center">
        ...
        <motion.div
          ...
          className="mb-10"
        >
          <p className="text-6xl font-normal text-foreground md:text-8xl tracking-tight">
            Delphia
          </p>
        </motion.div>
        ...
        <motion.h1
          ...
          className="mb-8 text-4xl font-normal leading-tight text-foreground md:text-6xl"
        >
          Stay in control.
        </motion.h1>
